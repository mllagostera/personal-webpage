export default {
  ...
  contactSendingSlow: 'This is taking longer than usual: the server was idle and is waking up.',
  ...
  loading: 'Loading…',
  loadingColdStart: 'The server was idle and is waking up. One moment…',
  openMenu: 'Open menu',
  ...
  cv: {
    ...
    languages: [
      ...
      },
      {
        ...
        bcp47: 'en',
        level: 'B2',
        usage: 'Professional, daily',
        evidence: 'International team of 7: ceremonies, documentation and PKI specifications in English.',
        note: 'Comfortable in technical meetings and writing; developing for high-level negotiation.',
        flag: 'flag:gb-4x3',
      },
    ],
    projects: [
