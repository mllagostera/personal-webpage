export default {
  ...
  contactSendingSlow: 'Està trigant més del que és habitual: el servidor estava en repòs i s\'està despertant.',
  ...
  loading: 'Carregant…',
  loadingColdStart: 'El servidor estava en repòs i s\'està despertant. Un moment…',
  openMenu: 'Obrir menú',
  ...
  cv: {
    ...
    languages: [
      ...
      },
      {
        ...
        bcp47: 'en',
        level: 'B2',
        usage: 'Professional, habitual',
        evidence: 'Equip internacional de 7 persones: cerimònies, documentació i especificacions de PKI en anglès.',
        note: 'Còmode en reunions tècniques i escriptura; en desenvolupament per a negociació a alt nivell.',
        flag: 'flag:gb-4x3',
      },
    ],
    projects: [
