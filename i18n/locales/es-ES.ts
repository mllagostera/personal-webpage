  ...
  cv: {
    ...
    languages: [
      ...
      },
      {
        ...
        bcp47: 'en',
        level: 'B2',
        usage: 'Profesional, de uso habitual',
        evidence: 'Lidero un equipo internacional deslocalizado de 7 personas: ceremonias ágiles, documentación técnica y especificaciones de PKI y firma electrónica en inglés. Formación técnica certificada con Thales e-Security.',
        note: 'Cómodo en reuniones técnicas y escritura profesional; en desarrollo para contextos de negociación y presentación a alto nivel.',
